...
from .models import User,contact, Message ,MultipleImages,MultipleindImage, apply_job,Comment,Comments, post_job,Payment, sectioned, Category, skilled_individuals, job_time, report_job, CompanyProfile, skilled_companies
...
admin.site.register(MultipleindImage)
